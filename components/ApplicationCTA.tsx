  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-10 text-center">
        ...
        {/* Headline */}
        <h2 className="font-condensed text-4xl sm:text-5xl lg:text-6xl xl:text-[4.5rem] font-bold uppercase leading-[0.95] text-[#EDE8DF] tracking-tight mb-8">
          Start with an<br />honest assessment.
        </h2>

        {/* Copy */}
        <p className="text-[#6B6B6B] text-base lg:text-lg leading-relaxed font-light max-w-2xl mx-auto mb-12">
        ...
        <p className="mt-6 text-[0.55rem] tracking-[0.2em] uppercase text-[#404040]">
          ...
          <div className="grid grid-cols-3 gap-px max-w-sm w-full">
            {tags.map((tag) => (
              <div key={tag} className="border border-white/[0.07] px-4 py-3 text-center">
                <p className="text-[0.55rem] tracking-[0.15em] uppercase text-[#404040]">{tag}</p>
              </div>
            ))}
          </div>
        </div>
